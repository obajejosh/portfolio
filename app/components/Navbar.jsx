    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4
                ...
                <a href="#top">
                    <Image src={isDarkMode ? assets.joshlogo_dark : assets.joshlogo} alt='logo' className='w-28 cursor-pointer mr-14' />
                </a>

                <ul className={`hidden md:flex items-center gap-6 lg:gap-8
            rounded-full px-12 py-3 ${isScroll ? "" : "bg-white shadow-sm bg-opacity-50 dark dark:border dark:border-white/50 dark:bg-transparent"} `}>
                ...
                top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition 
