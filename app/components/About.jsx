    ...
    >
        ...
        className='text-center text-5xl font-Ovo'>
            ...
            className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
                ...
                className='flex-1'>
                    <p className='mb-10 max-w-2xl font-Ovo'>I'm an experienced Software Developer & Technology Consultant with over a
                    decade and half of professional expertise in the several fields.
                    Throughout my career, I have had the privilage of collaborating 
                    with reknown organizations and conglomorates,
                    ...
                    className='flex items-center gap3 sm:gap-5'>
